        ...
        <form className="w-full space-y-4">
          ...
          <div className="relative">
            <input
              ...
              className="w-full mt-1 px-4 py-3 pr-12 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white/90 text-gray-800 transition-all duration-200"
            ...
            <button
              type="button"
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 focus:outline-none focus:text-blue-600 transition-colors duration-200 p-1"

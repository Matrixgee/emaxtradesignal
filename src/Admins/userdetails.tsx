...
import ConfirmUnsuspendModal from "../components/Modals/confirmunsuspend";
import ConfirmDeleteModal from "../components/Modals/confimdeletemodal";
import ConfirmClearAcct from "../components/Modals/confirmclearmodal";
...
const UserDetails = () => {
  ...
  if (!oneUser)
    return <div className="bg-red-100 text-gray-800 p-4">Loading...</div>;

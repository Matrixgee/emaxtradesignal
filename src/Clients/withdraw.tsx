        ...
        <div className="p-6 pb-20">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2 flex items-center">
              <ArrowDownLeft className="w-8 h-8 mr-3 text-blue-400" />
              Withdrawal
            </h1>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-slate-900/50 border border-blue-500/20 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-blue-400/50 focus:ring-2 focus:ring-blue-400/20 transition-all"
                      />
                    </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-t border-blue-500/20 pt-3">
                    <div className="flex justify-between font-semibold">
                      ...
                      <span className="text-blue-400">${amount || "0.00"}</span>
                    </div>
                  </div>
                </div>

        ...
        <div className="p-6 pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="bg-slate-900/40 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-slate-900/50 border border-blue-500/20 rounded-lg text-white focus:outline-none focus:border-blue-400/50 focus:ring-2 focus:ring-blue-400/20 transition-all"
                    >
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-gradient-to-r from-blue-400 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-500 hover:to-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 shadow-lg"
            ...
            <div className="bg-slate-900/40 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className="border border-blue-500/10 rounded-lg bg-slate-900/60 overflow-hidden"
                  >
                    <button

...
const Deposit = () => {
  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-slate-900/95 via-blue-900/30 to-slate-900/95"></div>
      <div className="fixed inset-0 bg-gradient-to-b from-blue-400/5 to-blue-500/5"></div>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/3 left-1/4 w-18 h-18 bg-blue-400/6 rounded-full blur-xl animate-pulse delay-700"></div>
      </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                      ...
                      <div
                        ...
                        className={`p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:scale-105 ${
                          selectedMethod === method.id
                            ...
                            : "border-blue-500/20 bg-slate-900/30 hover:border-blue-400/30"
                        }`}
                      >
                        ...
                        <div className="space-y-1 text-sm">
                          <p className="text-slate-300">
                            Fee:{" "}
                            <span className="text-blue-300">{method.fee}</span>
                          </p>
                          <p className="text-slate-300">
                            Min:{" "}
                ...
                <div className="bg-slate-900/40 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      min="10"
                      className="w-full pl-10 pr-4 py-4 bg-slate-900/50 border border-blue-500/20 rounded-lg text-white placeholder-slate-400 focus:border-blue-400/50 focus:outline-none focus:ring-2 focus:ring-blue-400/20 transition-all"
                    />
                  </div>
                ...
                <div className="bg-slate-900/40 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                  ...
                  <div className="bg-slate-900/60 border border-blue-500/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button
                        ...
                        className="flex items-center space-x-1 text-blue-300 hover:text-white transition-colors px-2 py-1 rounded hover:bg-blue-500/10"
                      >
                        {copied ? (
                    ...
                    <div className="break-all text-white font-mono text-sm bg-slate-900/80 p-3 rounded border border-blue-500/10 hover:bg-slate-900/60 transition-colors">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-900/40 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                  ...
                  <button
                    ...
                    className="w-full mt-6 py-3 bg-gradient-to-r from-blue-400 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-500 hover:to-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 hover:scale-105 active:scale-95"
                  >
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="bg-slate-900/40 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                  ...
                  {!proof ? (
                    <div className="border-2 border-dashed border-blue-500/30 rounded-lg p-8 text-center hover:border-blue-400/50 transition-colors">
                      ...
                      <label className="cursor-pointer">
                        <input
                          ...
                          className="hidden"
                        />
                        <span className="inline-flex items-center px-4 py-2 bg-blue-500/20 text-blue-400 rounded-lg hover:bg-blue-500/30 transition-colors">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-slate-900/60 rounded-lg border border-blue-500/20">
                ...
                <div className="bg-slate-900/40 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-slate-900/60 rounded-lg border border-blue-500/10">

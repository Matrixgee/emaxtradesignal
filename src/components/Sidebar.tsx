...
const Sidebar: React.FC<SidebarProps> = ({ active, setActive }) => {
  ...
  return (
    <div className="relative">
      ...
      {active && (
        <div
          className="fixed inset-0 bg-blue-500 backdrop-blur-sm z-20 md:hidden"
      ...
      <aside className={`sidebar ${active ? "active" : ""}`}>
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/95 via-blue900/30 to-blue-900/95 backdrop-blur-xl"></div>
        <div className="absolute inset-0 bg-gradient-to-b from-blue400/5 to-blue500/5"></div>

        {/* Animated particles */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-10 left-4 w-20 h-20 bg-blue400/10 rounded-full blur-xl animate-pulse"></div>
          <div className="absolute bottom-20 right-4 w-16 h-16 bg-blue500/10 rounded-full blur-xl animate-pulse delay-1000"></div>

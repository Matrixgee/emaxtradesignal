      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Ready to take your trading to the next level? Our expert team is
            here to guide you through every step of your investment journey.
          </p>
        </motion.div>
          ...
          >
            <motion.div variants={itemVariants} className="mb-8">
              ...
              <p className="text-gray-600">
                Fill out the form below and our trading experts will get back to
                you within 24 hours.
              </p>
            </motion.div>
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <p className="text-gray-600 mb-8">
                Choose the best way to reach us. Our dedicated support team is
                available to assist you with all your trading needs.
              </p>
            </motion.div>
        ...
        >
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of successful traders who trust our platform. Get
            started with a free consultation and discover how we can help you
